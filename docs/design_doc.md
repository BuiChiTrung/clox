...
- Compiler cons: + Translation overhead before runtime, may have to translate that won't be used.
...
Lox doesn’t *need* `for` loops, they just make some common code patterns more pleasant to write. These kinds of features are called **syntactic sugar**.
**Parsing rule**
...
void bind_this_kw_to_class_method(LoxInstance &instance) {
		...
		// enclosing_env = class_env
		this->enclosing_env->identifier_table["this"] =
